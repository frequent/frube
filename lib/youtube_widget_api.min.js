/* 2018-03-03 https://s.ytimg.com/yts/jsbin/www-widgetapi-vflZ8rDo4/www-widgetapi.js */
...
function v(a,b){var c=a.split("."),d=k;c[0]in d||!d.execScript||d.execScript("var "+c[0]);for(var e;c.length&&(e=c.shift());)c.length||void 0===b?d[e]&&d[e]!==Object.prototype[e]?d=d[e]:d=d[e]={}:d[e]=b}
...
g.B=function(a){a.id=this.g;a.channel="widget";a=xa(a);var b=this.b;var c=Ba(this.a.src);b=0==c.indexOf("https:")?[c]:b.a?[c.replace("http:","https:")]:b.c?[c]:[c,c.replace("http:","https:")];if(!this.a.contentWindow)throw Error("The YouTube player is not attached to the DOM.");for(c=0;c<b.length;c++)try{/*CUSTOM silence "Failed to execute 'postMessage' on 'DOMWindow': The target origin provided ('https://www.youtube.com') does not match the recipient window's origin"*/if(this._skipped){if(navigator.onLine){/*CUSTOM END*/this.a.contentWindow.postMessage(a,b[c])/*CUSTOM*/}}else{this._skipped=true}/*CUSTOM END*/}catch(d){if(d.name&&"SyntaxError"==d.name)Ha(d,"WARNING");else throw d;}};function ab(a){return(0==a.search("cue")||0==a.search("load"))&&"loadModule"!=a}
